...
with open('saved_csv/solar_24hr_realistic.csv', 'w', newline='') as f:
    writer = csv.writer(f)
...
with open('saved_csv/wind_24hr_realistic.csv', 'w', newline='') as f:
    writer = csv.writer(f)
...
with open('saved_csv/load_24hr_datacenter.csv', 'w', newline='') as f:
    writer = csv.writer(f)
...
print("  1. saved_csv/solar_24hr_realistic.csv")
print("  2. saved_csv/wind_24hr_realistic.csv")
print("  3. saved_csv/load_24hr_datacenter.csv")
print()
print("Key patterns:")
