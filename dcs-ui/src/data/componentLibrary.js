...
export const COMPONENT_LIBRARY = [
  ...
  // D) Power Electronics / Conversion
  {
    ...
    components: [
      ...
      { id: 'it-pcs-rect-inv', name: 'Rect/Inv', fullName: 'UPS line rectifier / inverter (one-line)', type: 'it-pcs-rect-inv', properties: { rating: 25, voltage: 0.48, unit: 'MW' } },
  ...
  // F) Switchgear & Protection
  {
    ...
    components: [
      ...
      { id: 'breaker-hv-boxed', name: 'HV CB (boxed)', fullName: 'HV breaker in 1×1 grid frame', type: 'breaker-hv-boxed', properties: { rating: 0, voltage: 34.5, unit: '' } },
      ...
      { id: 'breaker-gen-13.8', name: 'Gen CB', fullName: 'Generator Circuit Breaker 13.8kV', type: 'breaker-gen', properties: { rating: 2000, voltage: 13.8, unit: 'A' } },
      ...
      { id: 'manual-line-switch', name: 'Man. line sw', fullName: 'Manual line disconnect (one-line)', type: 'manual-line-switch', properties: { rating: 3500, voltage: 34.5, unit: 'A' } },
  ...
  // G) Measurement & Instrumentation
  {
    ...
    components: [
      ...
      { id: 'current-transformer-800', name: 'CT', fullName: 'Current Transformer 800:1', type: 'ct', properties: { rating: 800, voltage: 0, unit: '800:1' } },
      { id: 'current-transformer-1500', name: 'CT', fullName: 'Current Transformer 1500:1', type: 'ct', properties: { rating: 1500, voltage: 0, unit: '1500:1' } },
      { id: 'current-transformer-2000', name: 'CT', fullName: 'Current Transformer 2000:1', type: 'ct', properties: { rating: 2000, voltage: 0, unit: '2000:1' } },
