...
const filterColumns = (dataArray) => {
  ...
  for(let i=0; i< dataArray.length; i=i+resolution ) {
    ...
    columns.push({
      ...
      "Data Center Load (kW)":data["P_gen (kW)"],
    })
  }
  return columns;
}
...
const DataCenterLoadChartComponent = React.memo(({ dataArray, run, animationDuration, lineColor }) => {
    ...
    <div style={{ textAlign: 'center' }}>
      ...
      <ResponsiveContainer minWidth={CHART_MIN_WIDTH} minHeight={CHART_MIN_HEIGHT} 
        ...
        >
          ...
          {run && (<div>
              <Line name="Generator Power (kW)" type="monotone"
...
export default DataCenterLoadChartComponent;
