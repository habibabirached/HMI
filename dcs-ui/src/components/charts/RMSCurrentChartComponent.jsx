...
const RMSCurrentChartComponent = ({ dataArray, run, animationDuration }) => {

  return (
    <div style={{ textAlign: 'center' }}>
      <Typography sx={{ fontSize: '1.2rem', fontWeight: 'bold', marginBottom: '2px' }}> RMS Current (kA) </Typography>
      <ResponsiveContainer minWidth={CHART_MIN_WIDTH} minHeight={CHART_MIN_HEIGHT} 
        ...
        >
          ...
          {run && (<div>
              ...
              <Line name="I_gen (kA)" type="monotone"
                    dataKey={(dataObj) => dataObj["I_gen (kA)"]}  
...
export default RMSCurrentChartComponent;
